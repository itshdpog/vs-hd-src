...
class TitleState extends MusicBeatState
{
	...
	function startIntro()
	{
		if (!initialized)
		{
			...
			// music.loadStream(Paths.music('kewlmusic'));
			// FlxG.sound.list.add(music);
			// music.play();

			if(FlxG.sound.music == null) {
				FlxG.sound.playMusic(Paths.music('kewlmusic'), 0);
		...
		if (FlxG.random.bool(15))
			{
				...
				{
					case 1:
						createCoolText(['Aflac', 'punchamosquito', 'sexteenH', 'Techsex']);
					case 3:
						addMoreText('present');
					case 4:
						deleteCoolText();
					case 7:
						addMoreText('Original OC mod');
					case 8:
						deleteCoolText();
					case 9:
					...
					case 12:
						deleteCoolText();
					case 13:
						addMoreText('VS Dream');
					case 14:
						addMoreText('By');
					case 15:
						addMoreText('some lonely kids');
					case 16:
						addMoreText('fuck u blend');
					case 17:					
						deleteCoolText();
					case 18:
						skipIntro();
			...
			{
				case 1:
					createCoolText(['ItsPixel', 'Kickafly', 'SixteenJ', 'Techsec']);
				// credTextShit.visible = true;
				case 2:
					addMoreText('aka Losers');
				// credTextShit.text += '\npresent...';
				...
				case 15:
					addMoreText('Team HD');
				case 16:
					addMoreText('no we didnt copy aflac');
				case 17:
					skipIntro();
				}
			}
